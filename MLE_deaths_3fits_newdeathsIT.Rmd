...
ggplot(datamleit) +
  geom_point(aes(Day_it, Deathsmleit),colour = 'purple', size = 0.5)
```
...
require(bbmle)
#  create negative likelihood functions for negbin and poisson distributions. The poisson distribution is given in equation (3-5) and the negative binomial function in given in equation (6-8). 
