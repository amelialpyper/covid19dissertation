...
data <- subset(data, location=="Italy"  & date>="2020-03-30" & date<=day_n, select = -c(iso_code, continent, stringency_index, population_density:life_expectancy, new_tests:tests_units)) #display only relavent columns and the UK data only,allowing for the 2-3 weeks for interventions to take effect
...
mcmc_acf(fit_sir_negbinLD, pars = pars)
```
