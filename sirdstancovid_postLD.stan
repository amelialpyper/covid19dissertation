...
//posterior distribution, reduction of 50% for both beta and sigma, no change for gamma and phi_inv
  //priors
  beta ~ lognormal(log(0.125),0.25);
  gamma ~ lognormal(log(0.1428),0.1);
  sigma ~ lognormal(log(0.0005),0.45);
  phi_inv ~ normal(0,5);
